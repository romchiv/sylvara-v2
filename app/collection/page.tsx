    ...
    <main className="min-h-screen bg-[#06060a]">
            ...
            <div className="flex items-center gap-2">
              {watches.map((w) => (
                <span
                  key={w.slug}
                  title={w.name}
                  className="w-7 h-7 rounded-full border-2 border-transparent hover:border-white/50 transition-all duration-200 hover:scale-110 cursor-pointer"
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-12 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {watches.map((watch) => (
            /* Card — uses z-layering: Link overlay (z-10), Acheter button (z-20) to avoid nested <a> */
            <div
              key={watch.slug}
            ...
            >
              {/* Transparent full-card link to product page */}
              <Link
              ...
              <div className="relative h-72 flex items-center justify-center p-8">
                <Image
                  ...
                  style={{ filter: `drop-shadow(0 20px 50px ${watch.theme.glow})` }}
                />
              </div>
              ...
              <div className="relative p-6 border-t border-white/8">
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  {/* z-20 so it captures clicks above the transparent Link overlay */}
                  <a
